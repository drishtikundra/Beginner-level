      ...
      <section id='examples'>
        ...
        <menu>
          ...
          tappedButton={selectedTopic=='geoinfo'}
           onSelect={()=>handleSelect('geoinfo')}>Geographical info</TabButton>
          <TabButton onSelect={()=>handleSelect('nightview')}>Night Sky View</TabButton>
          <TabButton onSelect={()=>handleSelect('impact')}>Impact on Humans</TabButton>
          <TabButton onSelect={()=>handleSelect('location')}>Locations to Watch</TabButton>
        </menu>
