...
export default function TabButton(props,onSelect,tappedButton) {
  ...
  return (
    <li className="ex">
        ...
        <button className={tappedButton?'tapped':undefined} onClick={props.onSelect} >{props.children}</button>
    </li>
  )
}
